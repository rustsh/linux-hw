...
2. Запустить named в разрешающем домене командой `semanage permissive -a named_t`.
    ...
    По сути, перевод SELinux в режим Permissive для отдельного домена. Лучше, чем предыдущий вариант, но всё равно ведёт к снижению безопасности.
