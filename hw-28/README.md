...
Перейдём на страницу http://192.168.33.10/blog/ и убедимся, что блог открывается:

![](images/ghost_main.png)

Чтобы создать аккаунт, перейдём по адресу http://192.168.33.10/blog/ghost/ нажмём кнопку **Create your account**:

![](images/ghost_setup.png)

![](images/ghost_account.png)

Теперь по адресу http://192.168.33.10/blog/ghost/ доступна панель администратора:

![](images/ghost_admin.png)

Создадим новый пост:

![](images/ghost_post.png)

![](images/ghost_check.png)

#### Teedy

Перейдём на страницу http://192.168.33.10/docs/ и убедимся, что система управления документами открывается:

![](images/teedy_start.png)

Имя пользователя по умолчанию — `admin`, пароль — `admin`. Выполним вход:

![](images/teedy_main.png)

Создадим документ и добавим в него файл (или несколько):

![](images/teedy_doc.png)

#### Netdata

Перейдём на страницу http://192.168.33.10/docs/ и убедимся, что система мониторинга открывается:

![](images/netdata_main.png)
